...
def one_run(
    *,
    ...
    while attempt < max_regen_attempts:
        ...
        ## uncomment this to change the priority of the attacker
        
        # attacker = HP, victim = LP under RM => T_attacker < T_victim
        # valid_pairs = [
        #     (a.name, v.name)
        #     for a in tasks
        #     for v in tasks
        #     if a.name != v.name and a.T_ms < v.T_ms
        # ]

        # if valid_pairs:
        #     attacker, victim = pair_rng.choice(valid_pairs)
        #     break
...
if __name__ == "__main__":
    ...
    out_xlsx = "trace_attack_counts_aRP_n5.xlsx"
    #out_csv = "trace_attack_counts_U0p1_to_U0p8_uunifast.csv"
    out_summary_csv = "trace_attack_summary_U0p1_to_U0p8_uunifast.csv"
